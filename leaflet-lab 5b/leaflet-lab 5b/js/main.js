...
function updatePropSymbols(map, attribute){
    map.eachLayer(function(layer){
        if (layer.feature && layer.feature.properties[attribute]){
            ...
            popupContent += "<p><b> :) " + year + ":</b> " + props[attribute] + " reported incident(s)</p>";
			
			//"<p><b>City:</b> " + feature.properties.City + "</p><p><b>Dec15:</b> " + feature.properties.Dec15 + " reported incident(s) </p>";
